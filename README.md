# Pure_vton_2nd_runpod_workflow
ComfyUI workflow Dockerized via [comfyui-wizard](https://comfy.getrunpod.io).
Submission: https://comfy.getrunpod.io/dashboard/submissions/kd75xkjnv9g6hqnjkvhfvd934x89m0km
## Pull the prebuilt image

We've already built and published this image on Docker Hub:

```bash
docker pull timpietruskyrunpod/comfyui-wizard:kd75xkjnv9g6hqnjkvhfvd934x89m0km
docker run --rm --gpus all -p 8188:8188 timpietruskyrunpod/comfyui-wizard:kd75xkjnv9g6hqnjkvhfvd934x89m0km
```
